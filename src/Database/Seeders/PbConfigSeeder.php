...
class PbConfigSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Config::updateOrCreate(['configkey' => '_API_ENABLED_'], ['configvalue' => true, 'name' => 'API Enabled', 'description' => 'API Enabled', 'module_id' => $moduleConfig->id]);
        Config::updateOrCreate(['configkey' => '_DEBUG_MODE_'], ['configvalue' => true, 'name' => 'Debug Mode', 'description' => 'Debug Mode', 'module_id' => $moduleConfig->id]);
    }
}
