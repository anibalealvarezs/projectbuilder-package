...
class StylesComposer {
    ...
    public function compose(View $view)
    {
        $styles = [
            ...
            [ 'comment' => 'Font Awesome', 'href' => '../../plugins/fontawesome-free/css/all.min.css' ],
            [ 'comment' => 'icheck bootstrap', 'href' => '../../plugins/icheck-bootstrap/icheck-bootstrap.min.css' ],
            [ 'comment' => 'Theme style', 'href' => '../../dist/css/adminlte.min.css' ]
        ];
